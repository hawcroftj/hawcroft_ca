...
<html lang="en" class="colour-p">
    ...
    <body id="body" class="colour-p">
        <?php include('nav.php'); ?>
        <div id="banner" class="jumotron text-center border-top border-bottom border-dark pb-3 colour-l1 text-d2">
            <h1 class="display-1">hawcroft.ca</h1>
            <h1><small>A perpetual work in progress. Not optimized for mobile.</small></h1>
        </div>
        <div class="container rounded mt-5 p-5 ">
            <div class="row">
                <div class="col text-center text-bulge">
